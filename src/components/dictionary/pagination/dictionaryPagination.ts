...
export class DictionaryPagination extends Component {
  ...
  constructor(parentNode: HTMLElement) {
    ...
    this.btnPrev = new Component(this.element, "button", ["pagination-btn__prev", "btn"], "Prev");
    this.numberPage = new Component(this.element, "span", ["pagination-number"], `Page: 1`);
    this.btnNext = new Component(this.element, "button", ["pagination-btn__next", "btn"], "Next");
  }
}